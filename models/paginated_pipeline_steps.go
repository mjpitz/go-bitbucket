...
func (m *PaginatedPipelineSteps) validateNext(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineSteps) validatePrevious(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineSteps) validateValues(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineSteps) UnmarshalBinary(b []byte) error {
	var res PaginatedPipelineSteps
