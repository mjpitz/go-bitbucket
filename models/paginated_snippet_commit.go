...
func (m *PaginatedSnippetCommit) validateNext(formats strfmt.Registry) error {
...
func (m *PaginatedSnippetCommit) validatePage(formats strfmt.Registry) error {
...
func (m *PaginatedSnippetCommit) validatePagelen(formats strfmt.Registry) error {
...
func (m *PaginatedSnippetCommit) validatePrevious(formats strfmt.Registry) error {
...
func (m *PaginatedSnippetCommit) validateSize(formats strfmt.Registry) error {
...
func (m *PaginatedSnippetCommit) validateValues(formats strfmt.Registry) error {
...
func (m *PaginatedSnippetCommit) UnmarshalBinary(b []byte) error {
	var res PaginatedSnippetCommit
