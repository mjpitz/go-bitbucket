...
func (m *PaginatedPipelineScheduleExecutions) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PaginatedPipelineScheduleExecutions) validateNext(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineScheduleExecutions) validatePrevious(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineScheduleExecutions) validateValues(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineScheduleExecutions) UnmarshalBinary(b []byte) error {
	var res PaginatedPipelineScheduleExecutions
