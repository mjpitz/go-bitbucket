...
func (m *PaginatedRepositoryPermissions) validateNext(formats strfmt.Registry) error {
...
func (m *PaginatedRepositoryPermissions) validatePage(formats strfmt.Registry) error {
...
func (m *PaginatedRepositoryPermissions) validatePagelen(formats strfmt.Registry) error {
...
func (m *PaginatedRepositoryPermissions) validatePrevious(formats strfmt.Registry) error {
...
func (m *PaginatedRepositoryPermissions) validateSize(formats strfmt.Registry) error {
...
func (m *PaginatedRepositoryPermissions) validateValues(formats strfmt.Registry) error {
...
func (m *PaginatedRepositoryPermissions) UnmarshalBinary(b []byte) error {
	var res PaginatedRepositoryPermissions
