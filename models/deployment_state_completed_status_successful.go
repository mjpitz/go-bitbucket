...
func (m DeploymentStateCompletedStatusSuccessful) MarshalJSON() ([]byte, error) {
...
func (m *DeploymentStateCompletedStatusSuccessful) Validate(formats strfmt.Registry) error {
	var res []error
...
var deploymentStateCompletedStatusSuccessfulTypeNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		deploymentStateCompletedStatusSuccessfulTypeNamePropEnum = append(deploymentStateCompletedStatusSuccessfulTypeNamePropEnum, v)
	}
}

// property enum
func (m *DeploymentStateCompletedStatusSuccessful) validateNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, deploymentStateCompletedStatusSuccessfulTypeNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *DeploymentStateCompletedStatusSuccessful) validateName(formats strfmt.Registry) error {
...
func (m *DeploymentStateCompletedStatusSuccessful) UnmarshalBinary(b []byte) error {
	var res DeploymentStateCompletedStatusSuccessful
