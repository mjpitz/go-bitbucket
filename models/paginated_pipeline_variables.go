...
func (m *PaginatedPipelineVariables) validateNext(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineVariables) validatePrevious(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineVariables) validateValues(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineVariables) UnmarshalBinary(b []byte) error {
	var res PaginatedPipelineVariables
