...
func (m *PaginatedDeploymentVariable) validateNext(formats strfmt.Registry) error {
...
func (m *PaginatedDeploymentVariable) validatePrevious(formats strfmt.Registry) error {
...
func (m *PaginatedDeploymentVariable) validateValues(formats strfmt.Registry) error {
...
func (m *PaginatedDeploymentVariable) UnmarshalBinary(b []byte) error {
	var res PaginatedDeploymentVariable
