...
func (m *PipelineStepStateCompletedExpired) Validate(formats strfmt.Registry) error {
	var res []error
...
var pipelineStepStateCompletedExpiredTypeNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		pipelineStepStateCompletedExpiredTypeNamePropEnum = append(pipelineStepStateCompletedExpiredTypeNamePropEnum, v)
	}
}

// property enum
func (m *PipelineStepStateCompletedExpired) validateNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, pipelineStepStateCompletedExpiredTypeNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PipelineStepStateCompletedExpired) validateName(formats strfmt.Registry) error {
...
func (m *PipelineStepStateCompletedExpired) UnmarshalBinary(b []byte) error {
	var res PipelineStepStateCompletedExpired
