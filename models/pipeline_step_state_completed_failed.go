...
func (m *PipelineStepStateCompletedFailed) Validate(formats strfmt.Registry) error {
	var res []error
...
var pipelineStepStateCompletedFailedTypeNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		pipelineStepStateCompletedFailedTypeNamePropEnum = append(pipelineStepStateCompletedFailedTypeNamePropEnum, v)
	}
}

// property enum
func (m *PipelineStepStateCompletedFailed) validateNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, pipelineStepStateCompletedFailedTypeNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PipelineStepStateCompletedFailed) validateName(formats strfmt.Registry) error {
...
func (m *PipelineStepStateCompletedFailed) UnmarshalBinary(b []byte) error {
	var res PipelineStepStateCompletedFailed
