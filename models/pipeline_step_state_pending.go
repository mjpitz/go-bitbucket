...
var pipelineStepStatePendingTypeNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		pipelineStepStatePendingTypeNamePropEnum = append(pipelineStepStatePendingTypeNamePropEnum, v)
	}
}

// property enum
func (m *PipelineStepStatePending) validateNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, pipelineStepStatePendingTypeNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PipelineStepStatePending) validateName(formats strfmt.Registry) error {
...
func (m *PipelineStepStatePending) UnmarshalBinary(b []byte) error {
	var res PipelineStepStatePending
