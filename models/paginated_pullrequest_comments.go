...
func (m *PaginatedPullrequestComments) validateNext(formats strfmt.Registry) error {
...
func (m *PaginatedPullrequestComments) validatePage(formats strfmt.Registry) error {
...
func (m *PaginatedPullrequestComments) validatePagelen(formats strfmt.Registry) error {
...
func (m *PaginatedPullrequestComments) validatePrevious(formats strfmt.Registry) error {
...
func (m *PaginatedPullrequestComments) validateSize(formats strfmt.Registry) error {
...
func (m *PaginatedPullrequestComments) validateValues(formats strfmt.Registry) error {
...
func (m *PaginatedPullrequestComments) UnmarshalBinary(b []byte) error {
	var res PaginatedPullrequestComments
