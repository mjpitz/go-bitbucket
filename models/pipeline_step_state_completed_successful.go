...
func (m *PipelineStepStateCompletedSuccessful) Validate(formats strfmt.Registry) error {
	var res []error
...
var pipelineStepStateCompletedSuccessfulTypeNamePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		pipelineStepStateCompletedSuccessfulTypeNamePropEnum = append(pipelineStepStateCompletedSuccessfulTypeNamePropEnum, v)
	}
}

// property enum
func (m *PipelineStepStateCompletedSuccessful) validateNameEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, pipelineStepStateCompletedSuccessfulTypeNamePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *PipelineStepStateCompletedSuccessful) validateName(formats strfmt.Registry) error {
...
func (m *PipelineStepStateCompletedSuccessful) UnmarshalBinary(b []byte) error {
	var res PipelineStepStateCompletedSuccessful
