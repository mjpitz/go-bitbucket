...
func (m *PaginatedPipelineSchedules) validateNext(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineSchedules) validatePrevious(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineSchedules) validateValues(formats strfmt.Registry) error {
...
func (m *PaginatedPipelineSchedules) UnmarshalBinary(b []byte) error {
	var res PaginatedPipelineSchedules
