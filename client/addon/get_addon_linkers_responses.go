...
func (o *GetAddonLinkersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewGetAddonLinkersDefault(response.Code())
...
func (o *GetAddonLinkersDefault) Error() string {
	return fmt.Sprintf("[GET /addon/linkers][%d] GetAddonLinkers default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetAddonLinkersDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
