...
func (o *GetAddonLinkersLinkerKeyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewGetAddonLinkersLinkerKeyDefault(response.Code())
...
func NewGetAddonLinkersLinkerKeyDefault(code int) *GetAddonLinkersLinkerKeyDefault {
	return &GetAddonLinkersLinkerKeyDefault{
		_statusCode: code,
	}
}
...
func (o *GetAddonLinkersLinkerKeyDefault) Code() int {
	return o._statusCode
}

func (o *GetAddonLinkersLinkerKeyDefault) Error() string {
	return fmt.Sprintf("[GET /addon/linkers/{linker_key}][%d] GetAddonLinkersLinkerKey default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetAddonLinkersLinkerKeyDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
