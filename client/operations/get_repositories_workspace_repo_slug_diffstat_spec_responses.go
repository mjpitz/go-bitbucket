...
func (o *GetRepositoriesWorkspaceRepoSlugDiffstatSpecReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetRepositoriesWorkspaceRepoSlugDiffstatSpecOK()
...
func NewGetRepositoriesWorkspaceRepoSlugDiffstatSpecOK() *GetRepositoriesWorkspaceRepoSlugDiffstatSpecOK {
	return &GetRepositoriesWorkspaceRepoSlugDiffstatSpecOK{}
}
...
func (o *GetRepositoriesWorkspaceRepoSlugDiffstatSpecOK) Error() string {
	return fmt.Sprintf("[GET /repositories/{workspace}/{repo_slug}/diffstat/{spec}][%d] getRepositoriesWorkspaceRepoSlugDiffstatSpecOK  %+v", 200, o.Payload)
}
...
func (o *GetRepositoriesWorkspaceRepoSlugDiffstatSpecOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PaginatedDiffstats)
