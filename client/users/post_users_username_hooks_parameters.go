...
// NewPostUsersUsernameHooksParams creates a new PostUsersUsernameHooksParams object
// with the default values initialized.
func NewPostUsersUsernameHooksParams() *PostUsersUsernameHooksParams {
	var ()
	return &PostUsersUsernameHooksParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostUsersUsernameHooksParamsWithTimeout creates a new PostUsersUsernameHooksParams object
...
// NewPostUsersUsernameHooksParamsWithContext creates a new PostUsersUsernameHooksParams object
...
// NewPostUsersUsernameHooksParamsWithHTTPClient creates a new PostUsersUsernameHooksParams object
...
/*PostUsersUsernameHooksParams contains all the parameters to send to the API endpoint
for the post users username hooks operation typically these are written to a http.Request
*/
...
func (o *PostUsersUsernameHooksParams) WithTimeout(timeout time.Duration) *PostUsersUsernameHooksParams {
...
func (o *PostUsersUsernameHooksParams) WithContext(ctx context.Context) *PostUsersUsernameHooksParams {
	o.SetContext(ctx)
	return o
}
...
func (o *PostUsersUsernameHooksParams) WithHTTPClient(client *http.Client) *PostUsersUsernameHooksParams {
...
func (o *PostUsersUsernameHooksParams) WithUsername(username string) *PostUsersUsernameHooksParams {
...
func (o *PostUsersUsernameHooksParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
