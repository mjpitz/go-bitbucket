...
func (o *GetRepositoriesWorkspaceRepoSlugDefaultReviewersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetRepositoriesWorkspaceRepoSlugDefaultReviewersOK()
...
func NewGetRepositoriesWorkspaceRepoSlugDefaultReviewersOK() *GetRepositoriesWorkspaceRepoSlugDefaultReviewersOK {
	return &GetRepositoriesWorkspaceRepoSlugDefaultReviewersOK{}
}
...
func (o *GetRepositoriesWorkspaceRepoSlugDefaultReviewersOK) Error() string {
	return fmt.Sprintf("[GET /repositories/{workspace}/{repo_slug}/default-reviewers][%d] getRepositoriesWorkspaceRepoSlugDefaultReviewersOK ", 200)
}

func (o *GetRepositoriesWorkspaceRepoSlugDefaultReviewersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
