...
// NewPostRepositoriesWorkspaceRepoSlugRefsBranchesParams creates a new PostRepositoriesWorkspaceRepoSlugRefsBranchesParams object
// with the default values initialized.
func NewPostRepositoriesWorkspaceRepoSlugRefsBranchesParams() *PostRepositoriesWorkspaceRepoSlugRefsBranchesParams {
	var ()
	return &PostRepositoriesWorkspaceRepoSlugRefsBranchesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPostRepositoriesWorkspaceRepoSlugRefsBranchesParamsWithTimeout creates a new PostRepositoriesWorkspaceRepoSlugRefsBranchesParams object
...
// NewPostRepositoriesWorkspaceRepoSlugRefsBranchesParamsWithContext creates a new PostRepositoriesWorkspaceRepoSlugRefsBranchesParams object
...
// NewPostRepositoriesWorkspaceRepoSlugRefsBranchesParamsWithHTTPClient creates a new PostRepositoriesWorkspaceRepoSlugRefsBranchesParams object
...
/*PostRepositoriesWorkspaceRepoSlugRefsBranchesParams contains all the parameters to send to the API endpoint
for the post repositories workspace repo slug refs branches operation typically these are written to a http.Request
*/
