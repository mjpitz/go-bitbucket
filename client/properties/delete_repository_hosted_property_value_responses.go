...
func (o *DeleteRepositoryHostedPropertyValueReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeleteRepositoryHostedPropertyValueNoContent()
...
func NewDeleteRepositoryHostedPropertyValueNoContent() *DeleteRepositoryHostedPropertyValueNoContent {
	return &DeleteRepositoryHostedPropertyValueNoContent{}
}
...
func (o *DeleteRepositoryHostedPropertyValueNoContent) Error() string {
	return fmt.Sprintf("[DELETE /repositories/{workspace}/{repo_slug}/properties/{app_key}/{property_name}][%d] deleteRepositoryHostedPropertyValueNoContent ", 204)
}

func (o *DeleteRepositoryHostedPropertyValueNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
