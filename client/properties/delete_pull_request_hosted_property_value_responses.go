...
func (o *DeletePullRequestHostedPropertyValueReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewDeletePullRequestHostedPropertyValueNoContent()
...
func NewDeletePullRequestHostedPropertyValueNoContent() *DeletePullRequestHostedPropertyValueNoContent {
	return &DeletePullRequestHostedPropertyValueNoContent{}
}
...
func (o *DeletePullRequestHostedPropertyValueNoContent) Error() string {
	return fmt.Sprintf("[DELETE /repositories/{workspace}/{repo_slug}/pullrequests/{pullrequest_id}/properties/{app_key}/{property_name}][%d] deletePullRequestHostedPropertyValueNoContent ", 204)
}

func (o *DeletePullRequestHostedPropertyValueNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
