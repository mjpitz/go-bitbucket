...
func (o *GetCommitHostedPropertyValueReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCommitHostedPropertyValueOK()
...
func NewGetCommitHostedPropertyValueOK() *GetCommitHostedPropertyValueOK {
	return &GetCommitHostedPropertyValueOK{}
}
...
func (o *GetCommitHostedPropertyValueOK) Error() string {
	return fmt.Sprintf("[GET /repositories/{workspace}/{repo_slug}/commit/{commit}/properties/{app_key}/{property_name}][%d] getCommitHostedPropertyValueOK ", 200)
}

func (o *GetCommitHostedPropertyValueOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
