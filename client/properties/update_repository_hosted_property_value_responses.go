...
func (o *UpdateRepositoryHostedPropertyValueReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewUpdateRepositoryHostedPropertyValueNoContent()
...
func NewUpdateRepositoryHostedPropertyValueNoContent() *UpdateRepositoryHostedPropertyValueNoContent {
	return &UpdateRepositoryHostedPropertyValueNoContent{}
}
...
func (o *UpdateRepositoryHostedPropertyValueNoContent) Error() string {
	return fmt.Sprintf("[PUT /repositories/{workspace}/{repo_slug}/properties/{app_key}/{property_name}][%d] updateRepositoryHostedPropertyValueNoContent ", 204)
}

func (o *UpdateRepositoryHostedPropertyValueNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
