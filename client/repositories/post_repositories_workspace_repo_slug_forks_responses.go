...
func (o *PostRepositoriesWorkspaceRepoSlugForksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 201:
		result := NewPostRepositoriesWorkspaceRepoSlugForksCreated()
...
func NewPostRepositoriesWorkspaceRepoSlugForksCreated() *PostRepositoriesWorkspaceRepoSlugForksCreated {
	return &PostRepositoriesWorkspaceRepoSlugForksCreated{}
}
...
func (o *PostRepositoriesWorkspaceRepoSlugForksCreated) Error() string {
	return fmt.Sprintf("[POST /repositories/{workspace}/{repo_slug}/forks][%d] postRepositoriesWorkspaceRepoSlugForksCreated  %+v", 201, o.Payload)
}
...
func (o *PostRepositoriesWorkspaceRepoSlugForksCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
