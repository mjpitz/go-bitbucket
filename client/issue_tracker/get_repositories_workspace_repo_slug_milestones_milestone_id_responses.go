...
func (o *GetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 404:
		result := NewGetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDOK() *GetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDOK {
	return &GetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDOK{}
}
...
func (o *GetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDOK) Error() string {
	return fmt.Sprintf("[GET /repositories/{workspace}/{repo_slug}/milestones/{milestone_id}][%d] getRepositoriesWorkspaceRepoSlugMilestonesMilestoneIdOK  %+v", 200, o.Payload)
}
...
func (o *GetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDNotFound() *GetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDNotFound {
	return &GetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDNotFound{}
}
...
func (o *GetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDNotFound) Error() string {
	return fmt.Sprintf("[GET /repositories/{workspace}/{repo_slug}/milestones/{milestone_id}][%d] getRepositoriesWorkspaceRepoSlugMilestonesMilestoneIdNotFound  %+v", 404, o.Payload)
}
...
func (o *GetRepositoriesWorkspaceRepoSlugMilestonesMilestoneIDNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
